        ...
        <div className=" flex flex-col md:flex-row justify-between">
          <div className=" w-full md:w-[50%] px-3 sm:mb-10 text-popp">
            <p>
              ...
              tapestry of my life's journey. My name is Achariya Dr. Sanjay Pant, a
              seasoned professional in the realms of astrology, vastu
              consultancy, numerology, success coaching, and authorship. With an
              enriching experience spanning ___ years, I've dedicated my life to
              unraveling the mysteries of existence and guiding others toward a
              harmonious and prosperous life.
            </p>
            <br />
            <p>
              Born and raised in the culturally rich city of Pithoragarh, Uttrakhand,
              my roots are deeply embedded in the spiritual essence of
              India.
            </p>
            <br />
            <p>
