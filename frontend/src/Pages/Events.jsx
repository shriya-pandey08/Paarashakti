...
import banner3 from "../images/alldebdatta-images/meditation.jpg";
    ...
    <section>
      ...
      <div className="text-center bg-fuchsia-700 mt-6 py-5 text-white w-full px-3">
        <p className="font-poppins">
          To discuss how Achariya Dr. Sanjay Pant can bring inspiration and
          enlightenment to your gathering.
        </p>
        <h3 className="font-poppins text-2xl">Contact Us at: +91 9997088291</h3>
      </div>
      <div className="mt-7">
        <Footer />
      </div>
